...
var mdbWrite = ngdb.getLayer('MongoDB', {
    dbName: 'facerank_db',
    collectionName: 'facecats_sets_less_rated_full'
});

var fileIN = "/home/stefano/Documents/mypapers/rob_experiment/mturk/data/lessRated.csv";
var reader = csv.createCsvFileReader(fileIN, {
    'separator': ',',
    'quote': '"',
    'escape': '"',       
    'comment': '',
...
// Load less rated images
reader.addListener('data', function(data) {
    lessRated[data[0]] = data[0];
});

// When all are loaded, start creating new random sets.
reader.addListener('end', function(data) {
    //console.log(lessRated);
    console.log(J.size(lessRated));
